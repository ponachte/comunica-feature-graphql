    ...
    describe('assignExhaustive', () => {
      ...
      it('for pattern with two sources', async() => {
        ...
        const selectorShapes = [
          ...
          await sourcePattern.source.getSelectorShape(emptyContext),
        ];
        const operationOut = actor.assignExhaustive(AF, operationIn, [ source1, sourcePattern ], selectorShapes);
